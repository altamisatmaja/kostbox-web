                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <!-- Custom Delimiters -->
                            <div class="col-xl-4 col-md-6 col-sm-12 mb-6 mb-xl-0">
                                <label class="form-label" for="custom-delimiter-mask">Custom
                                    Delimiters</label>
                        ...
                        <div class="row">
                            <div class="col-12 mb-8">
                                <div class="maxLength-wrapper">
                                    ...
                                    <input type="text" id="maxLength-example1" class="form-control maxLength-example"
                                        maxlength="25" />
                            ...
                            <div class="col-12 mb-2">
                                <div class="maxLength-wrapper">
                                    ...
                                    <textarea id="maxLength-example2" class="form-control maxLength-example" rows="3"
